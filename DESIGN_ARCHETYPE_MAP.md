...
|theme/templates/contracts/contract_detail.html|WorkspacePage|WorkspacePage|Medium|Context-rich page combining panels/details/actions|Panel density and secondary actions vary|High|Medium|Workspace panel/header conventions and state patterns|
...
|theme/templates/contracts/invoice_detail.html|WorkspacePage|WorkspacePage|Medium|Context-rich page combining panels/details/actions|Panel density and secondary actions vary|High|Medium|Workspace panel/header conventions and state patterns|
|theme/templates/contracts/invoice_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|Low|Canonical form-field and command header primitives|
|theme/templates/contracts/invoice_list.html|QueuePage|QueuePage|Medium|Record-oriented page with list/table/filter behavior|Mixed utility and canonical primitives may coexist|Medium|Low|Canonical QueuePage wrappers available|
...
|theme/templates/contracts/search_results.html|QueuePage|QueuePage|Medium|Global result queue across entities|Uses ad-hoc gray utility cards/lists|High|Low|Adopt canonical queue wrappers and status text styles|
