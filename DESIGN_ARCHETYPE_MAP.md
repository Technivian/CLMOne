...
|theme/templates/contracts/audit_log_list.html|ExceptionPage|ExceptionPage|High|Audit stream is operational exception/compliance evidence feed|Legacy gray table stack on some rows|High|**MIGRATED Batch 7 Step 5** — page-wrap, page-header, page-title, page-subtitle, filter form (onchange preserved), panel overflow-hidden, tbl-head/tbl-th/tbl-row/tbl-td, badge-sm (CREATE→green, UPDATE→blue, DELETE→red, else→gray), empty-state, pagination preserved|Audit log read-only; no create action; filter onchange="this.form.submit()" preserved; pagination querystring pre-existing issue left as-is|
...
|theme/templates/contracts/checklist_item_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, panel, panel-inner, form-label, c-muted, c-danger, btn-primary-grad text-white|Canonical form-field and command header primitives|
...
|theme/templates/contracts/compliance_checklist_detail.html|ExceptionPage|ExceptionPage|Medium|Exception/compliance/alert oriented operational flow|Severity/status emphasis inconsistent|High|**MIGRATED Batch 7 Step 6** — page-wrap, page-header, page-title (checklist.name), page-subtitle (regulation), page-actions (btn-ghost back + btn-primary-grad edit), 2-col grid, panel+panel-head+panel-inner for details sidebar and items panel; badge-sm status (COMPLETE→green, IN_PROGRESS→blue, NOT_STARTED→gray); item toggle POST forms with csrf_token + onchange preserved exactly; Add Item form csrf_token preserved; bg-gray-600 Add button→btn-primary-grad; shadow-md panels→panel|Item toggle checkbox onchange POST behavior preserved exactly; attachments conditional preserved; 2 POST forms with CSRF both present|
|theme/templates/contracts/compliance_checklist_form.html|ExceptionPage|ExceptionPage|Medium|Exception/compliance/alert oriented operational flow|Severity/status emphasis inconsistent|High|**MIGRATED Batch 7 Step 6** — page-wrap, page-header, page-title (create/edit conditional), page-subtitle, panel+panel-inner, grid col-span layout preserved, form-label on all fields, c-danger field errors added, enctype="multipart/form-data" preserved, btn-ghost cancel, btn-primary-grad text-white save; shadow-md→panel|enctype preserved for attachments; id_for_label preserved on all labels; create/edit mode conditional preserved|
|theme/templates/contracts/compliance_checklist_list.html|ExceptionPage|ExceptionPage|Medium|Exception/compliance/alert oriented operational flow|Severity/status emphasis inconsistent|High|**MIGRATED Batch 7 Step 6** — page-wrap, page-header, page-title, page-subtitle, page-actions (btn-primary-grad create), filter form (search+status+submit), panel overflow-hidden table, tbl-head/tbl-th/tbl-row/tbl-td, badge-sm (COMPLETE→green, IN_PROGRESS→blue, else→gray), c-link View/Edit, empty-state; shadow-md raw table wrapper→panel|Search+status filter form preserved; filter params search/status carried through selects|
...
|theme/templates/contracts/contract_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|**MIGRATED — Batch 7 Step 9 (final non-auth template)**|✅ Done|—|page-wrap/page-header/page-title/page-actions; panel+panel-inner form wrapper; form-label; c-muted help_text; c-danger errors; btn-primary-grad text-white submit; btn-ghost preview+cancel; draft sections block + `<template>` + drag-and-drop JS preserved verbatim|
...
|theme/templates/contracts/data_inventory_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, page-actions, panel, panel-inner, enctype preserved, form-label, c-muted, c-danger, btn-primary-grad text-white, btn-ghost back|Canonical form-field and command header primitives|
...
|theme/templates/contracts/dd_risk_form.html|ExceptionPage|ExceptionPage|Medium|Exception/compliance/alert oriented operational flow|Severity/status emphasis inconsistent|High|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, panel, panel-inner, form-label, c-muted, c-danger, btn-primary-grad text-white|Exception severity badge + queue conventions|
|theme/templates/contracts/dd_task_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, panel, panel-inner, form-label, c-muted, c-danger, btn-primary-grad text-white|Canonical form-field and command header primitives|
|theme/templates/contracts/deadline_form.html|ExceptionPage|ExceptionPage|Medium|Exception/compliance/alert oriented operational flow|Severity/status emphasis inconsistent|High|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, panel, panel-inner, form-label, c-muted, c-danger, btn-primary-grad text-white, btn-ghost cancel|Exception severity badge + queue conventions|
...
|theme/templates/contracts/document_detail.html|WorkspacePage|WorkspacePage|Medium|Context-rich page combining panels/details/actions|Panel density and secondary actions vary|High|**MIGRATED Batch 7 Step 7** — page-wrap, page-header, page-title (document.title), page-subtitle (version/type/status), page-actions (btn-primary-grad Download with `download` attr preserved + btn-ghost Edit); panel+panel-inner for metadata; 2-col grid preserved; badge-sm badge-yellow (Attorney-Client Privilege) + badge-sm badge-red (Confidential); `<pre>` extracted_text preserved; panel+panel-head for Version History + Version Lineage; panel+panel-head+panel-inner for OCR Review; all `download` attrs preserved on version links; c-link for compare/download; `file_hash` code block preserved|`download` attribute preserved on 3 file links (current + versions + lineage); is_privileged/is_confidential badge semantics preserved; OCR review conditional preserved|
|theme/templates/contracts/document_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, panel, panel-inner, enctype preserved, form-label, c-muted, c-danger, btn-primary-grad text-white, btn-ghost cancel|Canonical form-field and command header primitives|
...
|theme/templates/contracts/document_ocr_queue.html|ExceptionPage|ExceptionPage|Medium|Exception/compliance/alert oriented operational flow|Severity/status emphasis inconsistent|High|**MIGRATED Batch 7 Step 5** — page-wrap, page-header, page-title, page-subtitle, page-actions (btn-ghost back to document_list), panel overflow-hidden, tbl-head/tbl-th/tbl-row/tbl-td, c-link for review, c-muted for version sub-line, empty-state; status left as plain tbl-td (OCR statuses unknown — avoid misclassification)|OCR status semantics not classified; left as plain text to avoid badge color misassignment|
...
|theme/templates/contracts/dsar_form.html|ExceptionPage|ExceptionPage|Medium|Exception/compliance/alert oriented operational flow|Severity/status emphasis inconsistent|High|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, page-actions, panel, panel-inner, enctype preserved, form-label, c-muted, c-danger, btn-primary-grad text-white, btn-ghost back|Exception severity badge + queue conventions|
|theme/templates/contracts/dsar_list.html|ExceptionPage|ExceptionPage|Medium|Exception/compliance/alert oriented operational flow|Severity/status emphasis inconsistent|High|**MIGRATED Batch 7 Step 5** — page-wrap, page-header, page-title, page-subtitle, page-actions (btn-primary-grad text-white create), panel overflow-hidden, tbl-head/tbl-th/tbl-row/tbl-td, badge-sm (COMPLETED→green, IN_PROGRESS→blue, is_overdue→red, else→yellow), c-link detail/edit, empty-state|DSAR overdue takes priority over status badge; is_overdue checked first in conditional|
|theme/templates/contracts/due_diligence_detail.html|WorkspacePage|WorkspacePage|Medium|Context-rich page combining panels/details/actions|Panel density and secondary actions vary|High|**MIGRATED Batch 7 Step 7** — page-wrap, page-header, page-title (process.title), page-subtitle (transaction_type + target_company), page-actions (btn-primary-grad Add Task + btn-ghost Add Risk/Edit); 3-col KPI panel grid; panel+panel-head for Tasks + Risks; task badge-sm (COMPLETED→green, IN_PROGRESS→blue, else→gray); risk badge-sm (CRITICAL→red, HIGH→yellow, MEDIUM→blue, LOW→green); toggle GET link→c-link preserved; empty-state on both lists; bg-green/orange/gray raw buttons retired|Toggle task link is GET-based (pre-existing, not a migration concern); risk badge HIGH→yellow (warning), CRITICAL→red|
|theme/templates/contracts/due_diligence_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 7** — page-wrap, page-header, page-title (create/edit conditional), page-subtitle c-muted, page-actions btn-ghost Back; panel+panel-inner; form-label on all 8 fields; c-danger field errors; non-field errors added; bg-blue-600 submit→btn-primary-grad text-white; raw cancel link→btn-ghost; required asterisk→c-danger span|No enctype (no file upload); 8 fields: title, transaction_type, target_company, deal_value, lead_attorney, start_date, target_completion_date, description|
...
|theme/templates/contracts/ethical_wall_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, page-actions, panel, panel-inner, enctype preserved, form-label, c-muted, c-danger, btn-primary-grad text-white, btn-ghost back|Canonical form-field and command header primitives|
...
|theme/templates/contracts/expense_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, panel, panel-inner, form-label, c-muted, c-danger, btn-primary-grad text-white|Canonical form-field and command header primitives|
...
|theme/templates/contracts/legal_hold_form.html|ExceptionPage|ExceptionPage|Medium|Exception/compliance/alert oriented operational flow|Severity/status emphasis inconsistent|High|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, page-actions, panel, panel-inner, enctype preserved, form-label, c-muted, c-danger, btn-primary-grad text-white, btn-ghost back|Exception severity badge + queue conventions|
|theme/templates/contracts/legal_hold_list.html|ExceptionPage|ExceptionPage|Medium|Exception/compliance/alert oriented operational flow|Severity/status emphasis inconsistent|High|**MIGRATED Batch 7 Step 5** — page-wrap, page-header, page-title, page-subtitle, page-actions (btn-primary-grad text-white create), panel overflow-hidden, tbl-head/tbl-th/tbl-row/tbl-td, badge-sm (ACTIVE→red intentional alert, RELEASED→green, else→gray), c-link detail/edit, empty-state|ACTIVE→badge-red intentional: active legal hold = litigation alert requiring urgent attention|
...
|theme/templates/contracts/legal_task_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, panel, panel-inner, form-label, btn-ghost cancel; btn-primary-grad text-white already present from Batch 6 Step 11|Canonical form-field and command header primitives|
...
|theme/templates/contracts/negotiation_note_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, panel, panel-inner, form-label, c-danger; btn-primary-grad text-white and btn-ghost already present from Batch 6 Step 11|Canonical form-field and command header primitives|
...
|theme/templates/contracts/risk_log_form.html|ExceptionPage|ExceptionPage|Medium|Exception/compliance/alert oriented operational flow|Severity/status emphasis inconsistent|High|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, panel, panel-inner, form-label, btn-ghost cancel; btn-primary-grad text-white already present from Batch 6 Step 11|Exception severity badge + queue conventions|
...
|theme/templates/contracts/signature_request_detail.html|WorkspacePage|WorkspacePage|Medium|Context-rich page combining panels/details/actions|Panel density and secondary actions vary|High|**MIGRATED Batch 7 Step 8** — page-wrap, page-header, page-title (object str), page-subtitle c-muted (routing order + status + role), page-actions (btn-ghost Back + btn-primary-grad Edit); amber needs_follow_up alert preserved (functional, no canonical amber btn); blue routing_blockers alert preserved; 2-col grid [2fr_1fr]; panel+panel-inner for main card with KPI sub-cells; panel+panel-head+panel-inner for Quick Actions + Execution Notes sidebars; available_transitions POST forms + csrf_token preserved; send_reminder POST form + csrf_token preserved; bg-blue-600 Edit→btn-primary-grad; raw back link→btn-ghost|Transition forms: POST with csrf_token (one per transition in loop); reminder form: POST with csrf_token; amber/blue alert boxes preserved (functional contextual, no canonical amber button exists)|
|theme/templates/contracts/signature_request_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, page-actions, panel, panel-inner, enctype preserved, form-label, c-muted, c-danger, btn-primary-grad text-white, btn-ghost back|Canonical form-field and command header primitives|
...
|theme/templates/contracts/time_entry_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, panel, panel-inner, form-label, c-muted, c-danger, btn-primary-grad text-white, btn-ghost cancel|Canonical form-field and command header primitives|
...
|theme/templates/contracts/trademark_request_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, panel, panel-inner, enctype preserved, form-label, btn-ghost cancel; btn-primary-grad text-white already present from Batch 6 Step 11|Canonical form-field and command header primitives|
...
|theme/templates/contracts/trust_account_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, panel, panel-inner, form-label, c-muted, c-danger, btn-primary-grad text-white, btn-ghost cancel|Canonical form-field and command header primitives|
...
|theme/templates/contracts/trust_transaction_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, panel, panel-inner, form-label, c-muted, c-danger, btn-primary-grad text-white|Canonical form-field and command header primitives|
...
|theme/templates/contracts/workflow_detail.html|WorkspacePage|WorkspacePage|Medium|Context-rich page combining panels/details/actions|Panel density and secondary actions vary|High|**MIGRATED Batch 7 Step 8** — page-wrap, page-header, page-title, page-subtitle (contract link→c-link, counterparty→c-muted), page-actions (btn-ghost View Contract + btn-ghost Back to Dashboard); Workflow Summary panel+panel-head with badge-sm status (ACTIVE→green, COMPLETED→blue, CANCELLED→red, else→gray); Add Step panel+panel-head+panel-inner with form-label × 5 + c-danger errors; Workflow Steps panel overflow-hidden with panel-head; step status circles preserved (✓/•/- icons, no canonical substitute); badge-sm step status (COMPLETED→green, IN_PROGRESS→blue, ESCALATED→red, SKIPPED→gray, else→yellow); badge-sm badge-purple step kind; c-muted text; c-warning blocked_reason; c-danger escalated_at; current_step bg-blue-50 highlight preserved; Complete POST form + csrf_token preserved (per step in loop); Update onclick JS preserved; modal div + openStepModal/closeStepModal script preserved verbatim; bg-gray-200 modal cancel→btn-ghost|JS modal: openStepModal/closeStepModal script preserved verbatim; workflow_step_complete POST form with csrf_token per step in loop; current_step highlight preserved|
|theme/templates/contracts/workflow_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 7** — page-wrap, page-header, page-title (create/edit conditional), page-subtitle c-muted, page-actions btn-ghost Back; panel+panel-inner; `card p-6`→panel+panel-inner; `c-red`→`c-danger`; `max-w-7xl px-6 py-8`→page-wrap; suggested_template blue info block preserved; template_comparison field_diffs/step_diffs loops preserved; JS `updateWorkflowName()` script preserved verbatim; btn-ghost/btn-primary-grad already present from Batch 6 Step 11|`<script>` block preserved verbatim (references form.name.id_for_label — pre-existing logic); suggested_template/template_comparison context vars unchanged; workflow_dashboard cancel link preserved|
|theme/templates/contracts/workflow_step_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, page-subtitle c-muted (workflow.title), panel, panel-inner, form-label, c-danger, btn-ghost cancel; btn-primary-grad text-white already present from Batch 6 Step 11|Canonical form-field and command header primitives|
...
|theme/templates/contracts/workflow_template_detail.html|WorkspacePage|WorkspacePage|Medium|Context-rich page combining panels/details/actions|Panel density and secondary actions vary|High|**MIGRATED Batch 7 Step 8** — page-wrap, page-header, page-title + badge-sm badge-gray version, page-subtitle c-muted (description), page-actions (btn-ghost Back + btn-primary-grad Create New Version with POST csrf); Version History panel overflow-hidden with panel-head + divide-y rows; badge-sm badge-blue Current + badge-sm badge-gray Derived; c-link Compare/Restore; Restore POST forms + csrf_token preserved; blue Add-step inline form preserved (bg-blue-50 border-blue-200 functional container); form-label on all 8 step fields; c-danger errors; Workflow Steps panel overflow-hidden with panel-head + divide-y rows; step order circle (bg-blue-100 rounded-full) preserved; badge-sm badge-blue step kind; c-muted metadata; text-xs text-red-600→c-danger on form errors; shadow-sm removed|Restore-version POST forms preserved per version in loop with csrf_token; Add-step POST form preserved with csrf_token; blue add-step container preserved (functional inline form in context-blue box)|
|theme/templates/contracts/workflow_template_form.html|CommandPage|CommandPage|High|Input/action-driven page with form-first flow|Field spacing and button variants may drift|Medium|**MIGRATED Batch 7 Step 4** — page-wrap, page-header, page-title, panel, panel-inner, form-label, c-danger, btn-primary-grad text-white (was bg-teal-600), btn-ghost cancel|Canonical form-field and command header primitives|
