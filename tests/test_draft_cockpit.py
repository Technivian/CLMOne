...
class ContractTemplatePickerEntryCardsPageTests(TestCase):
    ...
    def test_entry_page_uses_premium_copy_sections_and_metadata(self):
        ...
        self.assertContains(response, 'dc-ds-card-grid--launch')
        self.assertContains(response, 'dc-ds-card--launch')
        self.assertContains(response, 'dc-ds-card__meta')
        self.assertContains(response, 'dc-ds-card__footer')
