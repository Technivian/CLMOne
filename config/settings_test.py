...
os.environ['EXCEPTION_CANONICAL_READ_ENABLED'] = 'false'
os.environ['EXCEPTION_CANONICAL_READ_ORG_ALLOWLIST'] = ''
os.environ['PAR_SEC_002_SEARCH_ENFORCEMENT_ENABLED'] = 'false'
os.environ['PAR_SEC_002_SEARCH_ABORT_FAIL_CLOSED'] = 'false'
os.environ['PAR_SEC_002_SEARCH_ENFORCEMENT_ENVIRONMENTS'] = ''
os.environ['PAR_SEC_002_SEARCH_ENFORCEMENT_ORG_ALLOWLIST'] = ''
...
EXCEPTION_CANONICAL_READ_ENABLED = False
