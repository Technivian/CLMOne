...
found. Phase 3B consolidated page headers and standard record-list scaffolds.
Phase 3C (`PHASE_3C_TABLE_STANDARDIZATION.md`) closed the remaining primary
list, Workflow Designer, and Command Center table migrations against the
