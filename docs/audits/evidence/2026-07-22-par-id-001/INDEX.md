...
**Status:** **In progress** — resolver parity merged (`598b7a12`); remediation decision package pending; flags default off; production authority still legacy; **GI-2026-07-22-PR58-PREAUTH-MERGE Ratified and Closed**  
