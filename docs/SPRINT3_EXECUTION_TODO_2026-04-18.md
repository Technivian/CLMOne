...
- [x] `SPR3-008` executive analytics evidence run (2026-06-01): multi-org snapshot generated via `generate_executive_analytics_evidence`; artifact in `evidence/spr3-008-executive-analytics/executive-analytics-evidence.json` (organization_count=1, bottlenecks captured, risk_trend 6-month window).
