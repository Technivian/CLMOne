"""Personal work queue aggregation for the My Work workspace.

Consolidates actionable items assigned to the signed-in user across reviews,
approvals, tasks, directed questions, privacy reviews, obligations, returned
items, and rejected corrections — without duplicating specialist workspaces.
"""
