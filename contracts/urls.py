...
urlpatterns = [
    ...
    path('dpa-reviews/<int:pk>/risks/', views.dpa_risk_item_create, name='dpa_risk_item_create'),
    ...
    path('workflows/templates/<int:pk>/duplicate/', views.workflow_template_duplicate, name='workflow_template_duplicate'),
    path('workflows/templates/<int:pk>/archive/', views.workflow_template_archive, name='workflow_template_archive'),
    path('workflows/templates/<int:pk>/delete/', views.workflow_template_delete, name='workflow_template_delete'),
    ...
    path('workflows/designer/approval-rules/', views.workflow_approval_route_list, name='workflow_approval_route_list'),
    path('workflows/designer/history/', views.workflow_designer_history, name='workflow_designer_history'),
