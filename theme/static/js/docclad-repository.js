...
/**
 * DocClad repository functionality
 * Provides advanced filtering, bulk selection, and details drawer
 */
class DoccladRepository {
    constructor() {
        this.selectedContracts = new Set();
        this.viewStorageKey = 'docclad-saved-views';
...
// Initialize when DOM is loaded and DocClad mode is enabled
document.addEventListener('DOMContentLoaded', () => {
    if (window.location.pathname.includes('/repository')) {
        window.doccladRepository = new DoccladRepository();
    }
});
